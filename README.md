...
Greedy luôn có depth hiệu dụng bằng 1; giá trị depth trong Settings chỉ áp dụng
cho Minimax và Alpha-Beta.
...
hơn. Panel metrics hiển thị thêm số nhánh đã cắt khi có.
...
```bash
python experiments/evaluate.py --games 4 --depth 2 --opening-moves 2 --seed 42
```
...
Các trận cùng chỉ số sử dụng những thế khai cuộc có seed cố định nên kết quả có
thể tái lập nhưng không lặp nguyên một ván. Phần tổng hợp loại self-play vì trận
một thuật toán đấu chính nó luôn kéo tỷ lệ về mức trung tính.
